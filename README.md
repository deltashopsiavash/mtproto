# DELTA MTProto Panel v5 - Shared Port
...
unzip mtproto_panel_v5.zip
rm -rf /opt/delta-proxy-panel/app /opt/delta-proxy-panel/requirements.txt
cp -r mtproto_panel_v5/app /opt/delta-proxy-panel/app
cp mtproto_panel_v5/requirements.txt /opt/delta-proxy-panel/requirements.txt
...
## v5 UI update
- طراحی پنل کامل ساده‌تر و حرفه‌ای‌تر شد.
- ساخت یوزر از Modal شناور انجام می‌شود.
- ویرایش یوزر از Modal انجام می‌شود.
- نمایش حجم با واحد MB/GB اصلاح شد.
